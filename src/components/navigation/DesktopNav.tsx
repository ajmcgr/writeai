...
export const DesktopNav = ({ isAuthenticated, handleLogout }: DesktopNavProps) => {
    ...
    return (
      <div className="hidden md:flex items-center gap-0">
        {subscriptionStatus === 'free' && (
          <Link to="/pricing">
            <Button variant="secondary" size="sm" className="mr-1 px-5">
              Upgrade
            </Button>
          </Link>
        )}
  ...
  return (
    <div className="hidden md:flex items-center gap-0">
      <Link to="/pricing">
        <Button variant="ghost" className="text-white hover:bg-[#9599d1] font-medium px-3">Pricing</Button>
      </Link>
      <Link to="/signin">
        <Button variant="ghost" className="text-white hover:bg-[#9599d1] font-medium px-3">Login</Button>
      </Link>
      <Link to="/signup">
